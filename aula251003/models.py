class UsuarioModel:
    ...
    _usuarios = [
        {"id":1, "nome": "Ana Silva", "email":"ana@gmail.com", "senha":"ana", "logado":False},
        {"id":2, "nome": "Bruno Costa", "email":"bruno@gmail.com", "senha":"bruno", "logado":False}
    ]
    ...
    def salvar(self, nome, email, senha):
        novo_usuario = {"id":self._proximo_id, "nome":nome, "email": email, "senha":senha, "logado":False}
