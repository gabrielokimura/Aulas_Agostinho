class UsuarioModel:
    usuarios = [{"id":1, "nome":"Gabriel Okimura Kerr", "email":"gabrielokimura@gmail.com", "senha":"senha123", "perfil":"admin"},
    ...
    quartos = [{"numero":123, "tipo":"simples", "capacidade":2, "preco_diaria":106.38, "descricao":"Quarto básico com uma cama de casal e banheiro", "status":"limpo", "localização":"Ala Nordeste", "disponivel":False},
    ...
    faturas = [{"id":1, "id_reserva":1, "data_emissao":"03/03/2025", "valor_servicos":4, "valor_diarias":425.52, "status_pagamento":"pago"}]



    itens= [{"id":1, "id_fatura":1, "id_servico":1, "quantidade":1, "valor":4, "data_consumo":"02/03/2025"}]
    ...
    def adicionar(self, nome, email, senha, perfil):
